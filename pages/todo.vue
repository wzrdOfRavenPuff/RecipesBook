...
const list = ref([
  ...
  },
  {
    ...
    label: [
      ...
      { id: 3, checked: false, topic: 'default', label: 'add Clever' },
      { id: 4, checked: false, topic: 'default', label: 'add minesweeper' },
    ],
  },
  {
    id: 5,
    ...
    open: false,
    subItems: true,
    topic: 'new game idea: Clever',
    label: [
      { id: 1, checked: false, topic: 'default', label: 'layout' },
      { id: 2, checked: false, topic: 'default', label: 'dice rolls' },
      { id: 3, checked: false, topic: 'default', label: 'click to put roll' },
      { id: 4, checked: false, topic: 'default', label: 'point count' },
    ],
  },
  {
    id: 6,
